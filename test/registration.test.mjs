// Tool-surface invariants for @three-ws/intel-mcp.
//
...
//
// Run: node --test packages/intel-mcp/test/registration.test.mjs
...
test('every tool is a read-only, live-data query', () => {
	for (const tool of TOOLS) {
		...
		// Live market data is never idempotent — the score/feed/ranking moves between calls.
